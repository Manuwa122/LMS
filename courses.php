...
<head>
   ...
   justify-content:center;
      ...
      .courses .box:nth-child(6n+1) .thumb{ background:#c73717; }
      .courses .box:nth-child(6n+2) .thumb{ background:#064b68; }
      .courses .box:nth-child(6n+3) .thumb{ background:#c45b08; }
      .courses .box:nth-child(6n+4) .thumb{ background:#4b148c; }
      .courses .box:nth-child(6n+5) .thumb{ background:#15577d; }
      .courses .box:nth-child(6n+6) .thumb{ background:#b72b6a; }
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="courses.php"><i class="fas fa-graduation-cap"></i><span>courses</span></a>s
   ...
   <div class="box-container">
      ...
      if(mysqli_num_rows($teachers) > 0){
         while($row = mysqli_fetch_assoc($teachers)){
            ...
            $teacher_id = $row['id'];
            $count_q = mysqli_query($conn, "SELECT * FROM videos WHERE teacher_id='$teacher_id'");
            $video_count = mysqli_num_rows($count_q);
      ?>
      ...
      <div class="box">
         ...
         <h3 class="title">
            <?php echo htmlspecialchars($row['subject']); ?> Lessons
         </h3>
         ...
         <a href="teacher_course_page.php?id=<?php echo $row['id']; ?>" class="inline-btn">
   View Class
</a>
      </div>
      ...
      <?php
         ...
         echo '<p class="empty">No teachers registered yet!</p>';
      }
      ?>
